...
def output_slurm(dataset, pretrained_type, bz, lr, epoch, scale_value, slurm_root_path):
    gpu_device = random.choice([ 'tesla_v100s-pcie-32gb', 'tesla_v100-pcie-32gb', 'tesla_v100-sxm2-16gb'])
    ...
    if gpu_device == "tesla_v100-sxm2-16gb":
        gpu_num = 1
    elif gpu_device == "tesla_v100s-pcie-32gb":
        gpu_num = 1
    elif gpu_device == 'tesla_v100-pcie-32gb':
        gpu_num = 1
...
if __name__ == '__main__':
    slurm_files = []
    slurm_root_path = 'slurm_multimodal_transform_face128_1229/'
    bz = 8
    epoch = 40
