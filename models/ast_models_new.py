...
class VTModel(nn.Module):
    ...
    """
    def __init__(self, label_dim=527, fstride=10, tstride=10, input_fdim=384, input_tdim=384, imagenet_pretrain=True, audioset_pretrain=False, model_size='base384', patch_num=256, verbose=True):
