...
class MTModel(nn.Module):
    def __init__(self, label_dim, audio_model, video_model, text_model, modals="tav",k=None):
    ...
    def forward(self, audio_input, video_input, text_input):
        ...
        #选取倒着的k个层
        audio_hidden_states = audio_hidden_states[-1*self.k:]
        video_hidden_states = video_hidden_states[-1*self.k:]
        text_hidden_states = text_hidden_states[-1*self.k:]
